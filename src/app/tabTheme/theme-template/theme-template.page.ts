...
import {Theme, ThemeTag, ThemeTagProp} from '../../../rqt-service/theme.service';
...
export class ThemeTemplatePage extends BasePage implements OnInit {
    ...
    getThemeRqt() {
        ...
        this.themeTmpRqt.info(this.tmpId, null).subscribe((res: Theme) => {
            this.themeData = res;
